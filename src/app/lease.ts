...
class Lease {
    ...
    public getNumberOfWeeks(): number {
        let numberOfWeeks = Math.ceil(this.numberOfDays / 7); // get ceil for accomodate partial weeks
    ...
    public getNumberOfMonths(): number {
        let numberOfMonths = Math.ceil(this.getNumberOfDays() / 365 * 12);
    ...
    public getTotalAmount(): number {
        let totalAmount = this.numberOfDays / 7 * this.weeklyAmount;
     ...
     */
    public getFortnightlyAmount(): number {
        let fortnightlyAmount = 2 * this.weeklyAmount;
    ...
    public getMonthlyAmount(): number {
        ...
        let monthlyAmount = Math.floor(this.getTotalAmount() / this.getNumberOfMonths());
